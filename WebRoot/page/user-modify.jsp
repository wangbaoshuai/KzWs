		...
		<div class="ui grid">
				...
				<div class="verticalMenu">
					<div class="ui vertical pointing menu fluid">
					     <a class="item" href="page/hotelnice.jsp">
  						...
  						<a class="active teal item" href="page/user-modify.jsp">
			...
			<div class="twelve wide column">
				...
				<div class="ui form vertical segment">
					<form action="updateUser.action" name="form" method="post">
					  <input type="hidden" name="uid" value="${ loginUser.UId}">
						<div class="two fields">
							<div class="field">
								<label>我的用户名</label>
								<div class="ui left labeled icon input">
									<input type="text" id="username" name="user.ULoginname" value="${loginUser.ULoginname}" >
									<i class="user icon"></i>
                        ...
                        <div class="two fields">
							<div class="field">
								<label>我的电话</label>
								<div class="ui left labeled icon input">
									<input type="text" id="username" name="user.UTelephone" value="${loginUser.UTelephone}" >
									<i class="user icon"></i>
									<div class="ui corner label"></div>
								</div>
							</div>
                        ...
                        <div class="two fields">
							<div class="field">
								<label>我的地址</label>
								<div class="ui left labeled icon input">
									<input type="text" id="username" name="user.UAddress" value="${loginUser.UAddress}" >
									<i class="user icon"></i>
									<div class="ui corner label"></div>
								</div>
							</div>
						...
						<div class="field">
							<label>我的头像</label>
								<div class="ui left labeled icon input">
								<input type="file" id="useremail" name="user.UImage" value="${loginUser.UImage}" >
								<i class="mail icon"></i>
								</div>
						</div>
						</div>
