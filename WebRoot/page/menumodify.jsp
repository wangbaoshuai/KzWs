...
<html>
  <head>
    ...
    <title>My JSP 'menumodify.jsp' starting page</title>
...
<div id="form">
<form action="updateMenu.action" method="post" enctype="multipart/form-data" onsubmit="return check()">
				<table width="600" height="600" border="1">
				<tr>
						<td>菜系编号:</td>
						<td><input type="text"  name="menu.MId" value="<s:property value="#session.menu.MId"/>" size="30" readonly="readonly"/></td>
					</tr>
					<tr>
						<td>菜系名称:</td>
						<td><input type="text" name="menu.MTitle" value="<s:property value="#session.menu.MTitle"/>" size="30"  id="zt"/></td>
					</tr>
					<tr>
						<td>菜系价格:</td>
						<td><input type="text" name="menu.MPrice" value="<s:property value="#session.menu.MPrice"/>"  size="30"  id="jg"/></td>
					</tr>
					 <tr> 
					     <td>菜系图片:</td>
					     <td><input type="file" name="img" size="30" value="<s:property value="#session.menu.MImg"/>" id="tp"/></td>
					 </tr>
					 <tr> 
					     <td>菜系类别:</td>
					     <td><SELECT class=text  name="menu.menutype.mtId" id="lx">
                         <OPTION selected value="-1">请选择</OPTION>
                           <s:iterator var="mety" value="#session.metyList">
                        <OPTION value="<s:property value="#mety.mtId"/>"><s:property value="#mety.mtName"/></OPTION>
                          </s:iterator>
                         </SELECT>   
                        </td>
					 </tr>
					<tr>
					    <td></td>
						<td><input type="submit" name="submit" value="修改" style="background: rgb(50, 180, 10); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;" 
						 />
