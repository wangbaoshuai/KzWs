...
<html>
  <head>
    ...
    <title>My JSP 'newmodify.jsp' starting page</title>
...
<script type="text/javascript">
   function check(){
   var aa=document.getElementById("fil").value;
   var bb=document.getElementById("bt").value;
...
<div id="form"><br/><br/>
   <form action="updateNew.action" method="post" enctype="multipart/form-data" onsubmit="return check()">
				<table width="800" height="380" border="1">
				   <tr>
						<td>新闻编号:</td>
						<td><input type="text" class="text" name="news.NId" value="<s:property value="#session.hnew.NId"/>" size="30" readonly="readonly"/></td>
					</tr>
					<tr>
						<td>新闻图片:</td>
						<td><input type="file" class="text" name="img" value="<s:property value="#session.hnew.NImage"/>" size="30" id="fil"/></td>
					</tr>
					<tr>
						<td>新闻标题:</td>
						<td><input type="text" class="text" name="news.NTitle" value="<s:property value="#session.hnew.NTitle"/>" size="40" id="bt"/></td>
					</tr>
					<tr>
						<td>新闻内容:</td>
						<td><textarea type="text" name="news.NContent" rows="4" cols="40" id="nr"><s:property value="#session.hnew.NContent" /></textarea></td>
					</tr>
					<tr>
						<td></td>
						<td><label><input type="submit" name="submit" value="修改" size="10" style="background: rgb(50, 182, 23); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;" 
						 /></label>
						  <a href="findNew.action?type=houtai&nowpage=1" style="background: rgb(182, 50, 23); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;"  >取消</a>
