...
<script type="text/javascript">
	   ...
	   if(confirm("是否确认要删除？"))
	   location.href="deleteNew.action?nid="+nid;
	   }
  function check(){
   var aa=document.getElementById("bt").value;
   var bb=document.getElementById("nr").value;
   var cc=document.getElementById("fil").value;
...
<div id="form"><br/><br/>
<form action="addNew.action" method="post" enctype="multipart/form-data" name="fname" onsubmit="return check()">
				<table width="600" height="480" border="1">
					 <tr>
						<td>新闻标题:</td>
						<td><input type="text"  name="news.NTitle" size="30" placeholder="在这里填写" id="bt"/></td>
					 </tr>
					 <tr> 
					     <td>新闻内容:</td>
					     <td><textarea name="news.NContent" rols="100" cols="30" placeholder="在这里填写" id="nr"></textarea></td>
					 </tr>
					 <tr> 
					     <td>新闻图片:</td>
					 ...
					 <tr>
						<td></td>
						<td><label><input type="submit" name="submit" value="添加" style="background: rgb(50, 180, 10); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;" />
						<a href="findNew.action?type=houtai&nowpage=1" style="background: rgb(180, 50, 10); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;"  >取消</a>
