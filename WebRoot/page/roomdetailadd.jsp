...
<script type="text/javascript">
 function check(){
   ...
   var cc=document.getElementById("dh").value;
   var dd=document.getElementById("sjj").value;
   var ee=document.getElementById("zk").value;
   var ff=document.getElementById("js").value;
   var gg=document.getElementById("ms").value;
   if(aa==-1){
    alert("请选择客房名称")
    return false;
   }
...
<div id="form">
<br>
<form action="addRoomDetail.action" method="post" onsubmit="return check()">
				<table width="700" height="580" border="1">
					 <tr> 
					     <td>客房名称:</td>
					     <td><SELECT class=text name="roomdetail.room.RId" id="zt">
                               <OPTION selected value="-1">请选择</OPTION>
                            <s:iterator var="room" value="#session.roomList">
                              <OPTION selected value="<s:property value="#room.RId"/>"><s:property value="#room.RTitle"/></OPTION>
                          </s:iterator>
                            </SELECT> 
                         </td>
					 </tr>
					 <tr>
						<td>客房别名:</td>
						<td><input type="text"  name="roomdetail.rdTitle"  size="30" placeholder="在这里填写" id="bm"/></td>
					 </tr>
					 <tr>
						<td>客房电话:</td>
						<td><input type="text"  name="roomdetail.rdTelephone" size="30" placeholder="在这里填写" id="dh"/></td>
					 </tr>
					 <tr> 
					     <td>实际价格:</td>
					     <td><input type="text" name="roomdetail.rdPrice" size="30" placeholder="在这里填写" id="sjj"/></td>
					 </tr>
					 <tr> 
					     <td>折扣价格:</td>
					     <td><input type="text"  name="roomdetail.rdDiscount" size="30" placeholder="在这里填写" id="zk"/></td>
					 </tr>
					<tr>
						 <td>每小时收费:</td>
					     <td><input type="text"  name="roomdetail.rdPerhourprice" size="30" placeholder="在这里填写" id="js"/></td>
					</tr>
					<tr>
						<td>客房描述:</td>
						<td><textarea type="text"  name="roomdetail.rdContent" cols="30" rows="3" placeholder="在这里填写" id="ms"></textarea></td>
					 </tr>
					<tr>
						<td></td>
