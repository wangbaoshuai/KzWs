...
<form action="updateOrder.action" method="post" >
 <input type="hidden" name="order.room.RId" value="<s:property value="#session.order.room.RId"/>"/>
				<table width="600" height="380" border="1">
				    <tr>
						<td>订单编号：</td>
						<td><input type="text"  name="order.OId" value="<s:property value="#session.order.OId"/>" readonly="readonly"/></td>
					</tr>
					 <tr>
						<td>酒店编码：</td>
						<td><input type="text"  name="order.room.hotel.HZip" value="<s:property value="#session.order.room.hotel.HZip"/>" readonly="readonly"/></td>
					</tr>
					<tr>
						<td>订单日期：</td>
						<td><input type="text" name="order.YDate" value="<s:property value="#session.order.YDate"/>" readonly="readonly"/></td>
					</tr>
					<tr>
						<td>订单状态：</td>
						<td><input type="radio" name="order.OStatus" value="1" >审核
						    <input type="radio" name="order.OStatus" value="0" checked="checked">不审核
						</td>
					</tr>
					<tr>
					   <td></td>
					   <td><input type="submit" name="submit" value="修改" style="background: rgb(12, 150,123); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;"  />
						    <a href="findOrder.action?nowpage=1" style="background: rgb(162, 50, 123); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;"  >取消</a>
						 </td>
					</tr>
				</table>
			</form>
