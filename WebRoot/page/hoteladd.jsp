...
<html>
  <head>
    ...
    <title>My JSP 'hoteladd.jsp' starting page</title>
...
<script type="text/javascript">
   function check(){
   var aa=document.getElementById("mc").value;
   var bb=document.getElementById("bm").value;
   var cc=document.getElementById("tp").value;
   var dd=document.getElementById("nr").value;
   var ee=document.getElementById("dz").value;
   var ff=document.getElementById("dh").value;
   var gg=document.getElementById("cs").value;
...
<div id="form">
   <form action="addHotel.action" method="post" enctype="multipart/form-data" onsubmit="return check()">
				<table width="800" height="580" border="1">
					 <tr>
						<td>酒店名称:</td>
						<td><input type="text" name="hotel.HName"  size="40" placeholder="在这里填写" id="mc"/></td>
					 </tr>
					  <tr>
						<td>酒店编码:</td>
						<td><input type="text" name="hotel.HZip"  size="40" placeholder="在这里填写" id="bm"/></td>
					 </tr>
					 <tr>
						<td>酒店图片:</td>
						<td><input type="file" name="img"  size="40" placeholder="在这里填写" id="tp"/></td>
					 </tr>
					 <tr> 
					     <td>酒店内容:</td>
					     <td><textarea name="hotel.HContent" rols="4" cols="30" placeholder="在这里填写" id="nr"></textarea></td>
					 </tr>
					 <tr> 
					     <td>酒店地址:</td>
					     <td><input type="text" name="hotel.HAddress" size="40" placeholder="在这里填写" id="dz"/></td>
					 </tr>
					 <tr> 
					     <td>酒店电话:</td>
					     <td><input type="text" name="hotel.HTelephone" size="40" placeholder="在这里填写" id="dh"/></td>
					 </tr>
					 <tr> 
					     <td>酒店城市:</td>
					     <td><SELECT class=text name="hotel.hcity.cityId" id="cs">
					...
					<tr>
						<td></td>
						<td><label><input type="submit" name="submit" value="添加" size="10" style="background: rgb(50, 180, 10); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;" />
